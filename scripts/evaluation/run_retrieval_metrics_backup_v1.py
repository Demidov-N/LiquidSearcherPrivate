...
def run_evaluation_pipeline(
    ...
    # Define the 3 references
    REFERENCES = ["Similarity", "LiquidityUplift", "Utility"]
    ...
    overall_metrics = pd.DataFrame(
        {
            ...
            "pearson_corr_rerank": [
                np.mean(
                    [
                        results_df[f"pearson_corr_rerank_{ref}_Recall@10"].mean()
            ...
            "spearman_corr_rerank": [
                np.mean(
                    [
                        results_df[f"spearman_corr_rerank_{ref}_Recall@10"].mean()
                        for ref in REFERENCES
                    ]
                ),
                np.mean(
